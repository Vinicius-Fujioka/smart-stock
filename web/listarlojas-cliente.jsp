<%-- 
    Document   : listarlojas-cliente
    Created on : 18/06/2021, 01:12:10
    Author     : Junim
--%>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          ...
          <p class="animate__animated fanimate__adeInUp">veja abaixo a lista das lojas cadastradas no nosso sistema</p>
          <p></p>
  ...
  <main id="main">
        ...
        <table border="3px" align="center" width="100%" bordercolor="#2f3244">
                <tr>
                    ...
                    <td bgcolor="#B4B6C5"  height="50px"><font color="black" size="5">Tipo</font></td>
                    <td bgcolor="#B4B6C5"  height="50px"><font color="black" size="5">Cidade</font></td>
                    <td bgcolor="#B4B6C5"  height="50px"><font color="black" size="5">Estoques</font></td>
                </tr>
                <c:forEach items="${lista}" var="loja">
                     <tr>
                        <td  height="50px"><font color="black" size="3">${loja.idloja}</font></td>
                        <td  height="50px"><font color="black" size="3">${loja.nome}</font></td>
                        <td  height="50px"><font color="black" size="3">${loja.tipo}</font></td>
                        <td  height="50px"><font color="black" size="3">${loja.cidade}</font></td>
                        <td  height="50px"><a href="ListarEstoquePorLojaCliente?codigo=${loja.idloja}">Estoque</a> </td>
                    </tr>
                </c:forEach>
            </table>
