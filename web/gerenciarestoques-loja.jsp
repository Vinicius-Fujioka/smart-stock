<%-- 
    Document   : gerenciarestoques-loja
    Created on : 18/06/2021, 01:13:23
    Author     : Junim
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
                ...
                <div class="carousel-item active">
                    <div class="carousel-container">
                        ...
                        <p class="animate__animated fanimate__adeInUp">veja abaixo seus estoques</p>
                        <p class="animate__animated fanimate__adeInUp">${mensagem}</p>
                        <p></p>
        ...
        <main id="main">
            ...
            <tr>
                <td bgcolor="#B4B6C5" height="50px"><font color="black" size="5">ID</font></td>
                <td bgcolor="#B4B6C5" height="50px"><font color="black" size="5">Nome</font></td>
                <td bgcolor="#B4B6C5" height="50px"><font color="black" size="5">Descrição</font></td>
                <td bgcolor="#B4B6C5" height="50px"><font color="black" size="5">Excluir</font></td>
            </tr>
            <c:forEach items="${lista}" var="estoque">
                 <tr>
                    <td height="50px"><font color="black" size="3">${estoque.idestoque}</font></td>
                    <td height="50px"><font color="black" size="3">${estoque.nome}</font></td>
                    <td height="50px"><font color="black" size="3">${estoque.descricao}</font></td>
                    <td height="50px"><font color="black" size="3"><a href="ExcluirEstoque?codigo=${estoque.idestoque}">Excluir</a></font></td>
                </tr>
            </c:forEach>
        </table>
            <form method="post" action="CadastrarEstoque">
                <input type="hidden" name="idestoque" value="${estoque.idestoque}"/>
                <table border="3px" align="center" width="100%" bordercolor="#2f3244">
                    <tr>
                        <td bgcolor="#B4B6C5" height="50px"><font color="black" size="5">Nome</font></td>
                        <td bgcolor="#B4B6C5" height="50px"><font color="black" size="5">Descrição</font></td>
                        <td bgcolor="#B4B6C5" height="50px"><font color="black" size="5">Cadastrar</font></td>
                    </tr>
                    <tr>
                        <td height="50px"><font color="black" size="3"><input type="text" name="nome" value="${estoque.nome}"/></font></td>
                        <td height="50px"><font color="black" size="3"><input type="text" name="quantidade" value="${estoque.descricao}"/></font></td>
                        <td height="50px" align="center"><font color="black" size="3" ><input type="submit" value="Cadastrar"/></font></td>
                    </tr>
                </table>
            </form>            
