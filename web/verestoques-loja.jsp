<%-- 
    Document   : verestoques-loja
    Created on : 21/06/2021, 00:05:59
    Author     : Junim
--%>
            ...
            <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
                ...
                <div class="carousel-item active">
                    <div class="carousel-container">
                        ...
                        <p class="animate__animated fanimate__adeInUp">veja abaixo os estoque da loja selecionada</p>
                        <p></p>
        ...
        <main id="main">
            ...
            <table border="3px" align="center" width="100%" bordercolor="#2f3244">
                <tr>
                    ...
                    <td bgcolor="#B4B6C5" height="50px"><font color="black" size="5">Produtos</font></td>
                </tr>
                ...
                <c:forEach items="${Estoque}" var="estoque">
                    <tr>
                        ...
                        <td height="50px"><font color="black" size="3"><a href="ListarProdutoPorEstoqueLoja?codigo=${estoque.idestoque}">Produtos</a></font></td>
                    </tr>
                </c:forEach>
            </table>
