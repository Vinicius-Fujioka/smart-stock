<%-- 
    Document   : reservas-loja
    Created on : 18/06/2021, 01:13:57
    Author     : Junim
--%>
    ...
    <body>
            ...
            <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
                ...
                <div class="carousel-item active">
                    <div class="carousel-container">
                        ...
                        <p class="animate__animated fanimate__adeInUp">veja abaixo as reservas que foram feitas dos seus produtos</p>
                        <p></p>
        ...
        <form method="post" action="reservasfeitas-cliente.jsp">    
            <table border="3px" align="center" width="100%" bordercolor="#2f3244">
                <tr>
                    <td bgcolor="#B4B6C5" height="50px"><font color="black" size="5">Produto</font></td>
                ...
                <tr>
                    <td height="50px"><font color="black" size="3">Dell Optiplex i7, 4GB RAM, 240GB SSD</font></td>
                    <td height="50px"><font color="black" size="3">Paulo Celso</font></td>
                    <td height="50px"><font color="black" size="3">1</font></td>
                    <td height="50px"<font color="black" size="3">Quero o que estiver em melhor estado</font></td>
                </tr>
            </table>
        </form>            
        </main><!-- End #main -->
