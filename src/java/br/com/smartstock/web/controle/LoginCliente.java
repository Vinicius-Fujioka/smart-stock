...
public class LoginCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Cliente cliente = (Cliente) dao.logar(login,senha);
        ...
        if(cliente.getIdcliente() != null){
            ...
            request.getRequestDispatcher("homepage-cliente.jsp").forward(request, response);
            ...
            System.out.println("Erro ao logar clienteCTR " +e.getMessage());
