 ...
 * @author cazuu
 */
@WebServlet(name = "CarregarLoja", urlPatterns = {"/CarregarLoja"})
public class CarregarLoja extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("loja", dao.carregar(idloja));
        
        request.getRequestDispatcher("cadastro-loja.jsp").forward(request, response);
        
        }catch(Exception e){
            System.out.println("Erro ao carregar lojaCTR " + e.getMessage());
        }
    }
