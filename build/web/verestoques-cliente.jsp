<%-- 
    Document   : verestoques-cliente
    Created on : 18/06/2021, 01:12:50
    Author     : Junim
--%>
            ...
            <table border="3px" align="center" width="100%" bordercolor="#2f3244">
                ...
                <c:forEach items="${Estoque}" var="estoque">
                    <tr>
                        ...
                        <td height="50px"><font color="black" size="3"><a href="ListarProdutoPorEstoque?codigo=${estoque.idestoque}">Produtos</a></font></td>
                    </tr>
                </c:forEach>
            </table>
