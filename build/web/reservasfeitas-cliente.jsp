<%-- 
    Document   : reservasfeitas-cliente
    Created on : 20/06/2021, 21:49:33
    Author     : Junim
--%>
            ...
            <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
                ...
                <div class="carousel-item active">
                    <div class="carousel-container">
                        <h2 class="animate__animated animate__fadeInDown">Sua reserva foi feita com sucesso! </h2>
                        <p class="animate__animated fanimate__adeInUp"><a href="homepage-cliente.jsp">Pagina Inicial</a></p>
                        <p></p>
