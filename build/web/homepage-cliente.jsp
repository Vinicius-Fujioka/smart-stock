<%-- 
    Document   : homepage-cliente
    Created on : 18/06/2021, 01:10:36
    Author     : Junim
--%>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Cliente, bem-vindo ao <span>SmartStock</span></h2>
          <p class="animate__animated fanimate__adeInUp">Desfrute de sua busca por produtos nas lojas locais e também
