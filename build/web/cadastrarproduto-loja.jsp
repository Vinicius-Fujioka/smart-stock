...
<%@page import="br.com.smartstock.web.modelo.Estoque"%>
    ...
    <body>
            ...
            <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
                ...
                <div class="carousel-item active">
                    <div class="carousel-container">
                        ...
                        <p class="animate__animated fanimate__adeInUp">cadastre seu produto abaixo</p>
        ...
        <main id="main">
            ...
            <form method="post" action="CadastrarProduto">
                <input type="hidden" name="idloja" value="${produto.idloja}"/>
                <table border="3px" align="center" width="100%" bordercolor="#2f3244">
                    <tr>
                        ...
                        <td bgcolor="#B4B6C5" height="50px"><font color="black" size="5">Preço</font></td>
                        <td bgcolor="#B4B6C5" height="50px"><font color="black" size="5">Estoque</font></td>
                        <td bgcolor="#B4B6C5" height="50px"><font color="black" size="5">Cadastrar</font></td>
                    </tr>
                    <tr>
                        <td height="50px"><font color="black" size="3"><input type="text" name="nome" value="${produto.nome}"/></font></td>
                        <td height="50px"><font color="black" size="3"><input type="text" name="quantidade" value="${produto.quantidade}"/></font></td>
                        <td height="50px"><font color="black" size="3"><input type="text" name="validade" value="${produto.validade}"/></font></td>
                        <td height="50px"<font color="black" size="3"><input type="text" name="preco" value="${produto.preco}"/></font></td>
                        <td height="50px">
                            <font color="black" size="3">
                            <select class="form-control" name="refestoque">
                                <option selected=""></option>
                                <c:forEach var="estoque" items="${estoque}">
                                <option value="${estoque.idestoque}">${estoque.nome}</option>
                                </c:forEach> 
                            </select> 
                            </font>
                        </td>
